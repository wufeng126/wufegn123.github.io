...
const ROLE_GROUPS = [
  ...
  },
  {
    group: '💰 预算',
    items: [
      { label: '工人工资明细', prompt: '查询张三的工资明细，按月份列出应发、实发/应付、已发和未发' },
      { label: '合同清单查询', prompt: '查询某项目合同清单，列出清单项、工作内容、单位、匹配量和合同单价' },
      { label: '清单项内容', prompt: '查询某项目某个清单项的工作内容、计量单位和合同单价' },
    ],
  },
  {
    group: '🏢 老板',
...
const TEMPLATE_CATEGORIES = [
  {
    group: '工人工资',
    items: [
      { label: '查询工人工资明细', prompt: '查询张三的工资明细，按月份列出应发、实发/应付、已发、未发余额和发放状态' },
      { label: '查询已发工资', prompt: '查询张三已发工资是多少，并列出已发对应的项目和月份' },
      { label: '查询未发余额', prompt: '查询张三还有多少工资未发，按项目和月份列出原因线索' },
    ],
  },
  {
    group: '合同清单',
    items: [
      { label: '查询项目合同清单', prompt: '查询某项目合同清单，列出清单项、工作内容、单位、匹配量和合同单价' },
      { label: '查询清单项单价', prompt: '查询某项目模板工程的工作内容、计量单位和合同单价' },
      { label: '合同清单缺失检查', prompt: '检查某项目是否已经导入结构化合同清单，没有的话告诉我缺什么' },
    ],
  },
  {
    group: '供应商&合同',
        ...
        <div className="border-t p-3">
          <div className="flex items-end gap-2">
            <Input
              ...
              placeholder="输入问题，例如：查询张三工资明细，或查询某项目合同清单"
