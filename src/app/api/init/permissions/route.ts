...
async function initPermissions(supabaseUrl: string, serviceKey: string) {
  ...
  const permissionsList = [
    ...
    { module: 'work_items', code: 'work_items.view', name: '工程量统计', sort_order: 10 },
  ...
  const permissionsTableData = [
    ...
    { resource: 'work_items', action: 'view', name: '工程量统计', category: '项目中心' },
    ...
    { resource: 'work_items', action: 'import', name: '导入工程量', category: '项目中心' },
    { resource: 'work_items', action: 'export', name: '导出工程量', category: '项目中心' },
