...
async function initPermissions(supabaseUrl: string, serviceKey: string) {
  ...
  const permissionsTableData = [
    ...
    { resource: 'team_groups', action: 'list', name: '班组档案列表', category: '班组管理' },
    { resource: 'team_groups', action: 'view', name: '查看班组档案', category: '班组管理' },
    { resource: 'team_groups', action: 'create', name: '新增班组档案', category: '班组管理' },
    { resource: 'team_groups', action: 'edit', name: '编辑班组档案', category: '班组管理' },
    { resource: 'team_groups', action: 'delete', name: '删除班组档案', category: '班组管理' },
    { resource: 'team_settlements', action: 'list', name: '班组结算列表', category: '班组管理' },
    { resource: 'team_settlements', action: 'view', name: '查看班组结算', category: '班组管理' },
    { resource: 'team_settlements', action: 'create', name: '新增班组结算', category: '班组管理' },
    { resource: 'team_settlements', action: 'edit', name: '编辑班组结算', category: '班组管理' },
    { resource: 'team_settlements', action: 'delete', name: '删除班组结算', category: '班组管理' },
