...
const PERMISSION_MENU_STRUCTURE = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: '工程量统计-列表', code: 'work_items:list', icon: 'list' },
      { name: '工程量统计-查看', code: 'work_items:view', icon: 'eye' },
      { name: '工程量统计-新增', code: 'work_items:create', icon: 'plus' },
      { name: '工程量统计-编辑', code: 'work_items:edit', icon: 'edit' },
      { name: '工程量统计-删除', code: 'work_items:delete', icon: 'trash' },
      { name: '工程量统计-进度', code: 'work_items:progress', icon: 'chart' },
