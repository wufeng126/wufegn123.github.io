...
const PERMISSION_MENU_STRUCTURE = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: '结算证据链-列表', code: 'evidence_chain:list', icon: 'list' },
      { name: '结算证据链-查看', code: 'evidence_chain:view', icon: 'eye' },
      { name: '结算证据链-新增', code: 'evidence_chain:create', icon: 'plus' },
      { name: '结算证据链-编辑', code: 'evidence_chain:edit', icon: 'edit' },
      { name: '结算证据链-删除', code: 'evidence_chain:delete', icon: 'trash' },
      { name: '结算证据链-导出', code: 'evidence_chain:export', icon: 'download' },
