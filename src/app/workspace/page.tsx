...
const DashboardPage = dynamic(() => import('@/components/dashboard-content'), { ssr: false });
...
const tabs: TabItem[] = [
  { key: 'dashboard', label: '业务工作台', href: '/workspace?tab=dashboard', content: DashboardPage, permission: 'dashboard:view' },
