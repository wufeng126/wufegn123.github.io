    ...
    <StandardDashboardLayout
      ...
      kpiSection={
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3">
          ...
          <KpiCard label="应付金额" value={stats.totalGrossPay} amountMode />
          <KpiCard label="实发金额" value={stats.totalNetPay} amountMode />
          <KpiCard label="已付金额" value={stats.totalPaid} amountMode />
          <KpiCard label="未付金额" value={stats.totalUnpaid} amountMode
