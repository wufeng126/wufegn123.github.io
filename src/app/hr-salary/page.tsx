...
const LivingAllowancesPage = dynamic(() => import('@/app/workers/living-allowances/page'), { ssr: false });
...
const tabs: TabItem[] = [
  ...
  { key: 'living-allowances', label: '生活费台账', href: '/hr-salary?tab=living-allowances', content: LivingAllowancesPage, permission: 'salaries:pay' },
