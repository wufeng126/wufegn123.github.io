...
type AiConfigShape = Record<string, unknown>;
...
export async function GET(request: NextRequest) {
  ...
  const safeConfig: AiConfigShape = { ...config } as AiConfigShape;
...
export async function PUT(request: NextRequest) {
  try {
    ...
    const updateData: AiConfigShape = {
    ...
    clearAIConfigCache();
    const safeResult: AiConfigShape = { ...(result.data as AiConfigShape) };
